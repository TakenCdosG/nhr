          ...
          <div class="property-item">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="excerpt" style="margin-bottom:15px;">
                ...
                <div><a class="more" href="<?php the_permalink(); ?>">LEARN MORE</a></div>
              </div> 
            </div>
...
<div class="container">
  <div class="row callto">
    ...
    <div class="col-lg-5 col-md-5">
      <div class="button">
        <a href="<?php echo get_post_meta($post->ID, 'callto_link', true); ?>"><?php echo get_post_meta($post->ID, 'callto_button', true); ?></a>
      </div>
    </div>
  </div>
</div>
